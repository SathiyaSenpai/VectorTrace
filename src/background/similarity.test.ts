...
describe("Similarity Utilities", () => {
	...
	describe("rankCandidates", () => {
		it("should rank candidate text segments by similarity", () => {
			const stored = [1, 0];
			const candidates = [
				{ text: "poor match", embedding: [0, 1], cssSelector: ".poor", xpathSelector: "/poor" },
				{ text: "exact match", embedding: [1, 0], cssSelector: ".exact", xpathSelector: "/exact" },
				{
					text: "partial match",
